 ...
 */
void BOOST_PP_CAT(init_module_,DataXCode)();                               
extern "C" __declspec(dllexport) _BOOST_PYTHON_MODULE_INIT(DataXCode)
{
	using namespace boost::python;
	def( "PrintVersion", PrintVersion, "Print module version of \"DataXCode.pyd\"." );
